---
title: 没有accept, 是否能建立tcp?
date: 2021-12-15 22:27:23
author: yuxuan
img: https://image.fyxemmmm.cn/blog/images/ins-26.jpg
top: false
hide: false
cover: false
coverImg: 
...
tags:
  ...
  - 操作系统
---
![握手建立连接流程](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-0.gif)
...
![不执行accept时抓包结果](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-1.jpg)
...
![TCP三次握手](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-2.jpg)

服务端代码，对socket执行bind方法可以绑定监听端口，然后执行`listen方法`后，就会进入监听（`LISTEN`）状态。内核会为每一个处于`LISTEN`状态的`socket` 分配两个队列，分别叫**半连接队列和全连接队列**。

![每个listen Socket都有一个全连接和半连接队列](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-3.jpg)



#### 半连接队列、全连接队列是什么

![半连接队列和全连接队列](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-4.jpg)
...
![半连接全连接队列的内部结构](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-5.jpg)
...
![tcp_abort_on_overflow为0](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-6.jpg)
...
![tcp_abort_on_overflow为1](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-7.jpg)
...
![syn攻击](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-8.jpg)
...
![tcp_syncookies=1](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-9.jpg)
...
![tcp报头_seq的位置](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-10.jpg)
...
![ack攻击](https://image.fyxemmmm.cn/blog/images/dir1/tcp01-11.gif)
