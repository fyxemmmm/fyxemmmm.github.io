---
title: send出去, 数据就发送了么?
date: 2021-12-21 22:47:58
author: yuxuan
img: https://image.fyxemmmm.cn/blog/images/ins-39.jpg
top: false
hide: false
cover: false
coverImg: 
...
![socket_api](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-3.jpg)
...
![一个socket有两个缓冲区](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-4.jpg)
...
![tcp_sendmsg 逻辑](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-5.jpg)
...
![send阻塞](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-6.jpg)

- 如果此时 socket 是非阻塞的，程序就会**立刻返回**一个 `EAGAIN` 错误信息，意思是  `Try again` , 现在缓冲区满了，你也别等了，待会再试一次。

![send非阻塞](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-7.jpg)
...
![recv阻塞](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-8.jpg)

- 如果此时 socket 是非阻塞的，程序就会**立刻返回**一个 `EAGAIN` 错误信息。

![recv非阻塞](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-9.jpg)

下面用一张图汇总一下，方便大家保存面试的时候用哈哈哈。

![recv非阻塞](https://image.fyxemmmm.cn/blog/images/dir1/tcp02-10.jpg)socket读写缓冲区满了的情况汇总
